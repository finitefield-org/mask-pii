...
2026-07-21にfinitefield-siteの`main`（`c06acbf8284ea1dcc1a15e184099f9103fdf7960`）を調査した。調査時点でGoページには既存の未コミット変更があり、この表はその作業ツリーを含む現状を記録している。英語entityのパスはfinitefield-siteの`web/content/entities/articles/oss/mask-pii/`からの相対パスである。登録先と公開状態は、重複管理を避けるため上のマスター進捗表を正本とする。

`現在のインストール欄`は英語entityの`page.steps.installation.command`を示す。`Web状態`の`一部整備`は実行可能なコマンドと例があるものの、コンテンツ契約を満たしていない状態、`要整備`はインストール欄が空で、usageがREADME参照だけの状態を示す。
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AWK | `/en/oss/mask-pii/awk/` | `awk/en.json` | `要整備` | 空 | [あり](awk/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Bash | `/en/oss/mask-pii/bash/` | `bash/en.json` | `要整備` | 空 | [あり](bash/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Bun | `/en/oss/mask-pii/bun/` | `bun/en.json` | `要整備` | 空 | [あり](bun/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Carbon | `/en/oss/mask-pii/carbon/` | `carbon/en.json` | `要整備` | 空 | [あり](carbon/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Common Lisp | `/en/oss/mask-pii/common-lisp/` | `common-lisp/en.json` | `要整備` | 空 | [あり](common-lisp/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Crystal | `/en/oss/mask-pii/crystal/` | `crystal/en.json` | `要整備` | 空 | [あり](crystal/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| D | `/en/oss/mask-pii/d/` | `d/en.json` | `要整備` | 空 | [あり](d/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Deno | `/en/oss/mask-pii/deno/` | `deno/en.json` | `要整備` | 空 | [あり](deno/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Elixir | `/en/oss/mask-pii/elixir/` | `elixir/en.json` | `要整備` | 空 | [あり](elixir/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Fish | `/en/oss/mask-pii/fish/` | `fish/en.json` | `要整備` | 空 | [あり](fish/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Go | `/en/oss/mask-pii/go/` | `go/en.json` | `一部整備` | `go get github.com/finitefield-org/mask-pii/go@v0.2.0` | [あり](go/README.md) | `status, license, release` | 2026-07-21 |
| Groovy | `/en/oss/mask-pii/groovy/` | `groovy/en.json` | `要整備` | 空 | [あり](groovy/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Hare | `/en/oss/mask-pii/hare/` | `hare/en.json` | `要整備` | 空 | [あり](hare/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Haskell | `/en/oss/mask-pii/haskell/` | `haskell/en.json` | `要整備` | 空 | [あり](haskell/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| JavaScript | `/en/oss/mask-pii/javascript/` | `javascript/en.json` | `要整備` | 空 | [あり](javascript/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Julia | `/en/oss/mask-pii/julia/` | `julia/en.json` | `要整備` | 空 | [あり](julia/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Lua | `/en/oss/mask-pii/lua/` | `lua/en.json` | `要整備` | 空 | [あり](lua/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Nim | `/en/oss/mask-pii/nim/` | `nim/en.json` | `要整備` | 空 | [あり](nim/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Nushell | `/en/oss/mask-pii/nushell/` | `nushell/en.json` | `要整備` | 空 | [あり](nushell/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| OCaml | `/en/oss/mask-pii/ocaml/` | `ocaml/en.json` | `要整備` | 空 | [あり](ocaml/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Odin | `/en/oss/mask-pii/odin/` | `odin/en.json` | `要整備` | 空 | [あり](odin/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Perl | `/en/oss/mask-pii/perl/` | `perl/en.json` | `要整備` | 空 | [あり](perl/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| PHP | `/en/oss/mask-pii/php/` | `php/en.json` | `要整備` | 空 | [あり](php/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Pony | `/en/oss/mask-pii/pony/` | `pony/en.json` | `要整備` | 空 | [あり](pony/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| PowerShell | `/en/oss/mask-pii/powershell/` | `powershell/en.json` | `要整備` | 空 | [あり](powershell/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Python | `/en/oss/mask-pii/python/` | `python/en.json` | `要整備` | 空 | [あり](python/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| R | `/en/oss/mask-pii/r/` | `r/en.json` | `要整備` | 空 | [あり](r/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Racket | `/en/oss/mask-pii/racket/` | `racket/en.json` | `要整備` | 空 | [あり](racket/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Red | `/en/oss/mask-pii/red/` | `red/en.json` | `要整備` | 空 | [あり](red/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Ruby | `/en/oss/mask-pii/ruby/` | `ruby/en.json` | `要整備` | 空 | [あり](ruby/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Rust | `/en/oss/mask-pii/rust/` | `rust/en.json` | `一部整備` | `cargo add mask-pii` | [あり](rust/README.md) | `status, output, license, release` | 2026-07-21 |
| Swift | `/en/oss/mask-pii/swift/` | `swift/en.json` | `要整備` | 空 | [あり](swift/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Tcl | `/en/oss/mask-pii/tcl/` | `tcl/en.json` | `要整備` | 空 | [あり](tcl/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| V | `/en/oss/mask-pii/v/` | `v/en.json` | `要整備` | 空 | [あり](v/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Zig | `/en/oss/mask-pii/zig/` | `zig/en.json` | `要整備` | 空 | [あり](zig/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
| Zsh | `/en/oss/mask-pii/zsh/` | `zsh/en.json` | `要整備` | 空 | [あり](zsh/README.md) | `status, install, load, example, output, repo, license, release` | 2026-07-21 |
